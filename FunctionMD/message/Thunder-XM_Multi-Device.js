...
${branch}${LETT++} ${prefix}play 
${branch}${LETT++} ${prefix}lagu 
${branch}${LETT++} ${prefix}musik 
${branch}${LETT++} ${prefix}tiktokvideo link
${branch}${LETT++} ${prefix}tiktokaudio link
${branch}${LETT++} ${prefix}instagramdownload link
...
const sections = [ { title: "Game", rows: [ { title: "Kuis Math", rowId: "#math", description: "Kuis Matematika"},{title: "Tebak Gambar", rowId: "#tebakgambar", description: "Game Tebak Gambar"},{title: "Tebak Kimia", rowId: "#tebakkimia", description: "Game Tebak Kimia"},{title: "Asah Otak", rowId: "#asahotak", description: "Game Asahotak"}, {title: "Susun Kata", rowId: "#susunkata", description: "Game Susunkata"},{title: "Tebak Kalimat", rowId: "#tebakkalimat", description: "Game Tebak Kalimat"}, {title: "Teka Teki", rowId: "#tekateki", description: "Teka Teki"},{title: "Cak Lontong", rowId: "#caklontong", description: "Game Cak Lontong"}, { title: "Tebak Anime", rowId: "#tebakanime", description: "Game Tebak Anime"}, {title: "Tebak Kabupaten", rowId: "#tebakkabupaten", description: "Game Tebak Kabupaten"}, {title: "Tebak Bendera", rowId: "#tebakbendera", description: "Game Tebak Bendera"}, {title: "Tebak Lagu", rowId: "#tebaklagu", description: "Game Tebak Lagu"}, {title: "Tebak Lirik", rowId: "#tebaklirik", description: "Game Tebak Lirik"}, ]}    ]
const listMessage = {text: "Rysans Bot Game",footer: `Selamat jawaban kamu benar🥳🎉\n\n[🎁]Kamu mendapatkan hadiah sebanyak ${_math[m.sender.split('@')[0]].monay} monay\n\nTotal monay kamu: ${getMonay(m.sender)}`, title: "List Game",buttonText: "Play Again",sections}
const sendm =  sock.sendMessage( from, listMessage, {quoted :m })
...
reply("Jawaban Salah!")
  ...
  //Kalo off yaa kaga, Harus tunggu besok :v
    ...
    if (chatmessage.includes(`Hasan`) || chatmessage.includes(`Hasan`)){
       sock.sendMessage(from, 
        { text: 'Ada perlu apa dengan owner ? Ketik #Owner saja bosqu' }, 
        { quoted : m })  
...
for (let i of bc) {
sock.sendMessage(i.id, { text: `*[ Rysans Bot BROADCAST ]*\n\n${q}` })
}
break
case 'couple': {
if (q.includes('--help')) return reply(examkosong) 
...
{      
 ...
 break
case 'mlbbxx':
              reply(`MOBILE LEGEND PAKET C\n65(59+6) Rp15.000\n129(117+12) Rp30.000\n194(176+18) Rp45.000\n323(293+30) Rp75.000\n388(352+36) Rp90.000\n530(469+61) Rp125.000\n595(528+67) Rp135.000\n724(645+79) Rp165.000\n1647(1395+252) Rp355.200`)
        break
 case 'leaderboard':
{      
   let txt = `「 *LEADERBOARD* 」\n\n`
...
if (q.includes('--help')) return reply(examkosong) 
  ...
  break  
  case 'mlbb':
              reply(`MOBILE LEGEND\n86(78+8) Rp20.300\n172(156+16) Rp40.600\n257(234+23) Rp60.900\n344(312+32) Rp81.200\n429(390+39) Rp101.500\n514(468+46) Rp121.800\n600(546+54) Rp142.100\n706(625+81) Rp162.400\n878(781+97) Rp203.000\n963(859+104) Rp223.300\n1050(937+112) Rp243.600\n1412(1250+162) Rp324.800`)
        break
case 'test':
              reply(`Nyala Maszehhh`)
        break
case 'script':
              reply(`Script dibuat oleh Rysans dan bersifat private 😱`)
        break
case 'mlbbx':
              reply(`MOBILE LEGEND PAKET B\n•42(38+4)💎=Rp10.000\n•70(64+6)💎=Rp16.000\n•140(127+13)💎=Rp32.000\n•284(254+30)💎=Rp64.000\n•355(317+38)💎=Rp80.000\n•425(381+44)💎=Rp96.000\n•716(633+83)💎=Rp160.000\n•1446(1252+194)💎=Rp320.000`)
        break
case 'genshin':
              reply(`GENSHIN IMPACT VIA ID\n60 Rp13.000\n330 Rp63.000\n1090 Rp190.000\n3880 Rp630.000\nMonthly Blessing Rp63.500`)
        break
case 'pubgm':
              reply(`UC PUBGM GLOBAL\n60 Rp13.800\n325 Rp68.000\n660 Rp136.000\n1800 Rp340.000\n3850 Rp680.000`)
        break
case 'valo':
              reply(`VALORANT VIA RIOT ID\n125 Rp15.000\n250 Rp30.000\n420 Rp50.000\n700 Rp80.000\n1120 Rp130.000\n1375 Rp150.000\n2075 Rp230.000\n2400 Rp250.000\n6400 Rp650.000`)
        break
case 'aov':
              reply(`AOV VIA OPEN ID (BIND FB) \n40 Rp9.500\n90 Rp18.500\n230 Rp46.000\n470 Rp91.000\n950 Rp182.000\n1430 Rp273.000`)
        break
case 'done':
                  if (!isOwner) return reply("Hanya dapat dilakukan oleh baginda Hasan bosque")
          reply(`Pesanan telah selesai di proses oleh yang mulia Hasan\n*Pukul :* ${moment().utcOffset('+0700').format('HH:mm')}\n*Tanggal :* ${moment.tz('Asia/Jakarta').format('DD/MM')}`)
       break
case 'efef':
             reply(`70  9.200\n100  13.381\n140  18.400\n210  27.600\n355  46.000\n425  55.200\n500  65.236\n720  92.000\nMM  28.000\nMB  140.000`)
     break
case 'pay':
         reply(`BCA  1750965918 an Hasan\nDana 1  085156044141\nOVO : 085156044141\nGOPAY  085156044141\n📌 UNTUK PEMBAYARAN VIA QRIS SILAHKAN KETIK #QRIS\nUNTUK QRIS BCA KETIK #BQRIS`)
    break
case 'listgame':
         reply(`LIST RYSANS TOP UP \n #ff \n #mlbb \n #mlbb2 \n #genshin \n #valo \n #pubgm \n #aov \n #pay`)
    break
case 'bqris':
              reply(`Mengirim QRIS BCA RYSANS TOP UP \n Silahkan buka https://i.ibb.co/YQqhH16/BCAQR-MBCA-20220108-212338.jpg`)
              break
case 'qris':
              reply(`QR E-WALLET RYSANS TOP UP \n Silahkan buka https://i.ibb.co/hH10WvL/IMG-20210911-WA0105.jpg`)
              break
  case 'darah':{
  if (!isDarah){ addInventoriDarah(m.sender, DarahAwal) }
   ...
   let buttonss = [{
     index: 1, 
      urlButton: {
       ...
       url: 'https://facebook.com/OwnerToxic'
       } 
     },     
     {
      index: 1, 
       ...
       url: 'https://www.instagram.com/rysaaaaan'
       }
       }, 
       {
       index: 1, 
